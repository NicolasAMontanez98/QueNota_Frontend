...
import { signInTeacher } from "../store/actions/teacherAction";
      ...
      {loading ? (
        ...
        >
          ...
          >
            ...
            <h1 className="h3 mt-3 font-weight-normal text-white">Profesor</h1>
          </div>
          <div className="card-body">
            ...
            >
              ...
              <div className="row">
                <div className="col">
                  <button
                    className="btn btn-lg btn-primary mt-2 btn-block"
                    type="submit"
                  >
                    Ingresar
                  </button>
                ...
                <div className="col">
                  <button
                    className="btn btn-lg btn-danger mt-2 text-decoration-none btn-block"
                    onClick={handleBack}
                  >
                    Regresar
                  </button>
